...
import com.twinkle.framework.core.asm.designer.InstanceBuilderDesigner;
import com.twinkle.framework.core.datastruct.builder.InstanceBuilder;
...
public class InstanceBuilderFactory {
    ...
    protected String getBuilderClassName(String _builderClassName) {
        return this.targetPackage + "." + _builderClassName.replace('.', '_') + "$InstanceBuilder";
    }
