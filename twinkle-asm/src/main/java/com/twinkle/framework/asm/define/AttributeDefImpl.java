...
import com.twinkle.framework.asm.Blob;
...
public class AttributeDefImpl implements AttributeDef, Cloneable {
    ...
    protected void setName(String _name) {
        this.name = _name;
        this.getterName = ClassDesignerUtil.getGetterName(_name);
        this.setterName = ClassDesignerUtil.getSetterName(_name);
        this.constantName = ClassDesignerUtil.getConstantName(_name);
        this.fieldName = ClassDesignerUtil.getFieldName(_name);
    }
