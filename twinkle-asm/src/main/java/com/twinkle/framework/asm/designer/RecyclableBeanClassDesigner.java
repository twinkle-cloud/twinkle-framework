...
public class RecyclableBeanClassDesigner extends GeneralBeanClassDesigner {
    ...
    protected void handleAttributeInit(MethodVisitor _visitor, String _className, AttributeDef _attrDef) {
        ...
        if (tempDefaultValue != null) {
            ...
            _visitor.visitFieldInsn(Opcodes.PUTFIELD, _className, ClassDesignerUtil.getFlagFieldName(_attrDef.getName()), TypeUtil.getFieldDescriptor(Type.BOOLEAN_TYPE));
        }
    }
    ...
    protected MethodVisitor addSetterDefinition(ClassVisitor _visitor, String _className, AttributeDef _attrDef) {
        ...
        if (_attrDef.isReadOnly()) {
            ...
            tempVisitor.visitFieldInsn(Opcodes.PUTFIELD, _className, ClassDesignerUtil.getFieldName(_attrDef.getName()), TypeUtil.getFieldDescriptor(_attrDef.getType().getType()));
            if (TypeUtil.isPrimitive(_attrDef.getType().getType())) {
                tempVisitor.visitVarInsn(Opcodes.ALOAD, 0);
                tempVisitor.visitInsn(Opcodes.ICONST_1);
                tempVisitor.visitFieldInsn(Opcodes.PUTFIELD, _className, ClassDesignerUtil.getFlagFieldName(_attrDef.getName()), TypeUtil.getFieldDescriptor(Type.BOOLEAN_TYPE));
            } else {
    ...
    protected MethodVisitor addFlagGetterDefinition(ClassVisitor _visitor, String _className, AttributeDef _attrDef) {
        ...
        tempVisitor.visitCode();
        tempVisitor.visitVarInsn(Opcodes.ALOAD, 0);
        tempVisitor.visitFieldInsn(Opcodes.GETFIELD, _className, ClassDesignerUtil.getFlagFieldName(_attrDef.getName()), TypeUtil.getFieldDescriptor(Type.BOOLEAN_TYPE));
    ...
    private MethodVisitor addMethodAttributeDef(MethodVisitor _visitor, String _className, AttributeDef _attrDef) {
        ...
        _visitor.visitFieldInsn(Opcodes.PUTFIELD, _className, ClassDesignerUtil.getFieldName(_attrDef.getName()), TypeUtil.getFieldDescriptor(_attrDef.getType().getType()));
        _visitor.visitVarInsn(Opcodes.ALOAD, 0);
        if (tempDefaultValueObj != null) {
            _visitor.visitInsn(Opcodes.ICONST_1);
        } else {
    ...
    private void addHashCodeDefinition(ClassVisitor _visitor, String _className) {
        ...
        if (!tempAttrDefList.isEmpty()) {
            ...
            while (tempItr.hasNext()) {
                ...
                tempVisitor.visitFieldInsn(Opcodes.GETFIELD, _className, ClassDesignerUtil.getFlagFieldName(tempAttrName), TypeUtil.getFieldDescriptor(Type.BOOLEAN_TYPE));
                ...
                tempVisitor.visitVarInsn(Opcodes.ALOAD, tempFIndex);
                tempVisitor.visitFieldInsn(Opcodes.GETFIELD, _className, ClassDesignerUtil.getFieldName(tempAttrName), TypeUtil.getFieldDescriptor(tempAttrType));
