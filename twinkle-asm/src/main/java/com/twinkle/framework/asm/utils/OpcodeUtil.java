...
public class OpcodeUtil implements Opcodes {
	 ...
	 * 
	 * @see {@link AbstractInsnNode AbstractInsnNode}:
	 *      <ul>
	 *      <li>{@link AbstractInsnNode#FIELD_INSN
	 *      FIELD_INSN}</li>
	 *      <li>{@link AbstractInsnNode#IINC_INSN
	 *      IINC_INSN}</li>
	 *      <li>{@link AbstractInsnNode#INSN INSN}</li>
	 *      <li>{@link AbstractInsnNode#INT_INSN
	 *      INT_INSN}</li>
	 *      <li>{@link AbstractInsnNode#INVOKE_DYNAMIC_INSN
	 *      INVOKE_DYNAMIC_INSN}</li>
	 *      <li>{@link AbstractInsnNode#JUMP_INSN
	 *      JUMP_INSN}</li>
	 *      <li>{@link AbstractInsnNode#LDC_INSN
	 *      LDC_INSN}</li>
	 *      <li>{@link AbstractInsnNode#LOOKUPSWITCH_INSN
	 *      LOOKUPSWITCH_INSN}</li>
	 *      <li>{@link AbstractInsnNode#METHOD_INSN
	 *      METHOD_INSN}</li>
	 *      <li>{@link AbstractInsnNode#MULTIANEWARRAY_INSN
	 *      MULTIANEWARRAY_INSN}</li>
	 *      <li>{@link AbstractInsnNode#TABLESWITCH_INSN
	 *      TABLESWITCH_INSN}</li>
	 *      <li>{@link AbstractInsnNode#TYPE_INSN
	 *      TYPE_INSN}</li>
