...
import com.twinkle.framework.asm.helper.CloneHelper;
import com.twinkle.framework.asm.helper.EqualsHelper;
...
public class GeneralBeanClassDesigner extends AbstractGeneralBeanClassDesigner {
    ...
    protected String getDefaultConstantName(AttributeDef _attrDef) {
        return _attrDef.getFieldName() + ClassDesignerUtil.DEFAULT_SUFFIX;
    }
