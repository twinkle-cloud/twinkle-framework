...
public enum BinEncoding {
    ...
    private static class BinaryCodec implements BinCodec {
        ...
        public String encode(byte[] _byteArray) {
            return com.twinkle.framework.asm.codec.Binary.encode(_byteArray);
        }

        @Override
        public byte[] decode(String _str) {
            return com.twinkle.framework.asm.codec.Binary.decode(_str);
        }
    }
    ...
    private static class HexCodec implements BinCodec {
        ...
        @Override
        public String encode(byte[] _byteArray) {
            return com.twinkle.framework.asm.codec.Hex.encode(_byteArray);
        }

        @Override
        public byte[] decode(String _str) {
            return com.twinkle.framework.asm.codec.Hex.decode(_str);
        }
    }
    ...
    private static class Base64Codec implements BinCodec {
        ...
        @Override
        public String encode(byte[] _byteArray) {
            return com.twinkle.framework.asm.codec.Base64.encode(_byteArray);
        }

        @Override
        public byte[] decode(String _str) {
            return com.twinkle.framework.asm.codec.Base64.decode(_str);
        }
    }
}
