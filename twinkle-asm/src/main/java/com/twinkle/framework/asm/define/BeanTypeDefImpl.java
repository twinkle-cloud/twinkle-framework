...
public class BeanTypeDefImpl extends BeanRefTypeDefImpl implements BeanTypeDef, Cloneable {
    ...
    public BeanTypeDefImpl(BeanTypeDescriptor _descriptor, ClassLoader _classLoader, Map<String, TypeDef> _typeDefMap) throws ClassNotFoundException {
        ...
        this.interfaceTypeDefs = ClassDesignerUtil.getParents(_descriptor.getInterfaceDescriptors(), _classLoader, _typeDefMap);
        this.attributes = ClassDesignerUtil.getAttributes(_descriptor.getAttributes(), _classLoader, _typeDefMap);
        this.annotations = ClassDesignerUtil.getAnnotations(_descriptor.getAnnotations(), _classLoader);
    }
