...
import com.twinkle.framework.core.asm.bytecode.NodeParentWriter;
...
public class ClassUtil {
	...
	private static ClassNode getNode(ClassReader cr) {
		...
		cr.accept(cn, AsmConfiguration.getInputFlags());
		return cn;
	}
	...
	public static byte[] getBytes(ClassNode cn) throws Exception {
		ClassWriter cw = new NodeParentWriter(AsmConfiguration.getOutputFlags());
		cn.accept(cw);
