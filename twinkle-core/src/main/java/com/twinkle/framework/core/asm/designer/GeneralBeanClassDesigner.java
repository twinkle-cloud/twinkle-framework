...
public class GeneralBeanClassDesigner extends AbstractBeanClassDesigner {
    ...
    protected void addClassDefinition(ClassVisitor _visitor, String _className, String _superName, List<AttributeDef> _attrDefList, BeanTypeDef _beanTypeDef) {
        ...
        this.addMethodsDefinition(_visitor, _className, _attrDefList);
    ...
    protected void addFields(ClassVisitor _visitor, List<AttributeDef> _attrDefList) {
        _attrDefList.parallelStream().forEach(item -> this.addField(_visitor, item));
    }
    ...
    protected FieldVisitor addField(ClassVisitor _visitor, AttributeDef _attrDef) {
        ...
        FieldVisitor tempVisitor = _visitor.visitField(Opcodes.ACC_PRIVATE, _attrDef.getFieldName(), TypeUtil.getFieldDescriptor(_attrDef.getType().getType()), tempFieldSignature, (Object) null);
