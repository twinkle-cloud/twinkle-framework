...
public class BeanTypeDefImpl extends BeanRefTypeDefImpl implements BeanTypeDef, Cloneable {
    ...
    public BeanTypeDefImpl(BeanTypeDescriptor descriptor, ClassLoader _classLoader) throws ClassNotFoundException {
        this(descriptor, _classLoader, new HashMap());
    }

    public BeanTypeDefImpl(BeanTypeDescriptor descriptor, ClassLoader _classLoader, Map<String, TypeDef> _typeDefMap) throws ClassNotFoundException {
        super(descriptor.getName(), TypeDefBuilder.getObjectType(descriptor.getClassName()));
        this.descriptor = descriptor;
        _typeDefMap.put(descriptor.getClassName(), this);
        this.parents = this.initBeanParents(descriptor, _classLoader, _typeDefMap);
        this.attributes = this.initBeanAttributes(descriptor, _classLoader, _typeDefMap);
        this.annotations = this.initAnnotations(descriptor.getAnnotations(), _classLoader);
    }
