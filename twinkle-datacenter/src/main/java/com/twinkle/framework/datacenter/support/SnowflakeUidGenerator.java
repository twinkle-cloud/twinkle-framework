...
import com.twinkle.framework.datacenter.exception.UidGenerateException;
import com.twinkle.framework.datacenter.utils.DateUtil;
import com.twinkle.framework.datacenter.utils.IpUtil;
...
/**
 * Copy From https://github.com/johnhuang-cn/snowflake-uid
 *
...
public class SnowflakeUidGenerator {
    ...
    public static final String DEFAULT_BASE_DATE = "2019-10-01";
    ...
    public SnowflakeUidGenerator(long workerId, String baseDate, int timeBits, int workerBits, int seqBits) {
		...
		Date date = DateUtil.parseByDayPattern(baseDate);
    ...
    public static long getWorkerIdByIP(int bits) throws UidGenerateException {
    	...
    	try {
			...
			long ip = IpUtil.ipV4ToLong(address.getHostAddress());
