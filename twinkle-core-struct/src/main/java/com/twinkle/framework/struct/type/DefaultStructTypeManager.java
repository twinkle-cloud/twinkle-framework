...
public class DefaultStructTypeManager implements StructTypeManager {
    ...
    public DefaultStructTypeManager() {
        this(INTERNAL_TYPE_MGR);
    }

    protected DefaultStructTypeManager(DefaultStructTypeManager _parentManager) {
    ...
    protected static DefaultStructTypeManager getInternalTypeManager() {
