...
public class ArrayAllocatorImpl implements ArrayAllocator {
    ...
    private static ByteArrayFactory byteArrayFactory = new ByteArrayFactory();
    ...
    public MutableByteArray newByteArray(int _size) {
        return byteArrayFactory.newArrayWrapper(_size);
    }
    ...
    public MutableByteArray wrap(byte[] _array, int _size) {
        return byteArrayFactory.wrap(_array, _size);
    }
    @Override
    public MutableByteArray wrap(byte[] _array) {
        return byteArrayFactory.wrap(_array);
    }
    @Override
