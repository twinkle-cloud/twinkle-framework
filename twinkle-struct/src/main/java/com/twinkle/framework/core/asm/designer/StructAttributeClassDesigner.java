...
import com.twinkle.framework.core.error.StructAttributeCopyException;
import com.twinkle.framework.core.lang.ref.AttributeRef;
import com.twinkle.framework.core.lang.ref.SAAttributeRefHandleImpl;
...
public final class StructAttributeClassDesigner extends SimpleReflectiveBeanClassDesigner implements ClassInitializer {
    ...
    protected MethodVisitor addClassInit(ClassVisitor _visitor, String _className, List<AttributeDef> _attrDefList) {
        ...
        for(AttributeDef tempDef : _attrDefList) {
            ...
            tempVisitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, STRUCTATTRIBUTETYPE_TYPE.getInternalName(), "getAttribute", TypeUtil.getMethodDescriptor(new Class[]{String.class}, AttributeDescriptor.class));
            ...
            tempVisitor.visitMethodInsn(Opcodes.INVOKESPECIAL, getFieldRefImpl().getInternalName(), "<init>", TypeUtil.getMethodDescriptor(new Class[]{AttributeDescriptor.class, Class.class, String.class, String.class}, Void.TYPE));
    ...
    protected MethodVisitor addObjectClassConstructorDefinition(MethodVisitor _visitor, String _className, AttributeDef _attrDef, int _parameterSize) {
        ...
        if (tempDefaultValue != null) {
            ...
            Type tempMappedJavaType = TypeUtil.mapStructAttributeType(_attrDef.getType().getType());
    ...
    protected MethodVisitor addCopyDefinition(ClassVisitor _visitor, String _className, List<AttributeDef> _attrList) {
        ...
        for(AttributeDef tempItem : _attrList) {
            ...
            tempVisitor.visitVarInsn(Opcodes.ALOAD, 0);
            tempVisitor.visitFieldInsn(Opcodes.GETFIELD, _className, TypeDefUtil.getFlagFieldName(tempItem.getName()), TypeUtil.getFieldDescriptor(Type.BOOLEAN_TYPE));
        ...
        for(AttributeDef tempItem : _attrList) {
            ...
            tempVisitor.visitVarInsn(Opcodes.ALOAD, 0);
            tempVisitor.visitFieldInsn(Opcodes.GETFIELD, _className, TypeDefUtil.getFieldName(tempItem.getName()), TypeUtil.getFieldDescriptor(tempItemType));
