...
import com.twinkle.framework.core.datastruct.serialize.AbstractSchemaBasedDeSerializer;
import com.twinkle.framework.core.datastruct.serialize.AbstractSchemaBasedSerializer;
import com.twinkle.framework.core.lang.struct.StructAttribute;
import com.twinkle.framework.core.lang.util.StructAttributeArray;
...
public class DeserializerGeneratorClassDesigner extends AbstractGeneratorClassDesigner {
    ...
    protected void generateOnBeanProperty(MethodVisitor _visitor, AttributeDescriptor _descriptor) {
        ...
        _visitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, ClassDesignerUtil.getInternalName(this.typeDescriptor.getClassName()), TypeDefUtil.getSetterName(_descriptor.getName()), ClassDesignerUtil.getMethodSignature(Void.TYPE, new Class[]{tempBeanClass}));
    }
    ...
    protected void generateOnArrayProperty(MethodVisitor _visitor, AttributeDescriptor _attrDescriptor, Class<?> _class) {
        ...
        if (tempElementTypeDescriptor.isPrimitive()) {
            ...
            _visitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, ClassDesignerUtil.getInternalName(_class), TypeDefUtil.getSetterName(_attrDescriptor.getName()), ClassDesignerUtil.getMethodSignature(Void.TYPE, new Class[]{StructAttributeArray.class}));
        }
    }
    ...
    protected void generateOnPrimitiveProperty(MethodVisitor _visitor, AttributeDescriptor _attrDescriptor, Class<?> _class) {
        try {
            ...
            String tempSetterName = TypeDefUtil.getSetterName(tempAttrName);
            String tempGetterName = TypeDefUtil.getGetterName(tempAttrName);
